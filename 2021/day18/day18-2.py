...
# Find the two snailfish numbers that add up to the largest magnitude number.
max_magnitude = 0
for a, b in itertools.combinations(sf_list, 2):
    x1 = reduce(add(a, b))
    x2 = reduce(add(b, a))
    m1 = magnitude(x1)
    m2 = magnitude(x2)
...
print(f'Largest magnitude of any sum of two different numbers: {max_magnitude}')
