...
# Benedikt Otto
#
# This is a relatively complex linear optimization problem, so even though I don't like
# to use external packages, the solution is substantially easier by using an SMT solver
# like z3.
import z3
