...
with open('../inputs/input_9.txt') as file:
...
# Calculate the previous value for each sequence and add the new values together.
total_sum = 0
for seq in sequences:
    print(seq)
    # Instead of rewriting the function, we can just reverse the list,
    # continue it to the right and then reverse the result again.
    seq.reverse()
